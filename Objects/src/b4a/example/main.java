...
String _password = "";
 ...
 //BA.debugLineNum = 63;BA.debugLine="Dim email As String";
_email = "";
 //BA.debugLineNum = 64;BA.debugLine="Dim password As String";
_password = "";
 //BA.debugLineNum = 65;BA.debugLine="email=EditText1.Text";
_email = mostCurrent._edittext1.getText();
 //BA.debugLineNum = 66;BA.debugLine="password=EditText2.Text";
_password = mostCurrent._edittext2.getText();
 //BA.debugLineNum = 71;BA.debugLine="job2.Initialize(\"Job2\", Me)";
mostCurrent._job2._initialize(processBA,"Job2",main.getObject());
 //BA.debugLineNum = 72;BA.debugLine="job2.PostString(\"http://8bd6c0d6.ngrok.io/ta_v2/e";
mostCurrent._job2._poststring("http://8bd6c0d6.ngrok.io/ta_v2/endpoint/login.php","email="+_email+"&password="+_password);
...
public static String  _jobdone(anywheresoftware.b4a.samples.httputils2.httpjob _job) throws Exception{
 ...
 //BA.debugLineNum = 38;BA.debugLine="Log(\"JobName = \" & Job.JobName & \", Success = \" &";
anywheresoftware.b4a.keywords.Common.Log("JobName = "+_job._jobname+", Success = "+BA.ObjectToString(_job._success));
 //BA.debugLineNum = 39;BA.debugLine="If Job.Success = True Then";
if (_job._success==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 40;BA.debugLine="Select Job.JobName";
switch (BA.switchObjectToInt(_job._jobname,"Job2")) {
case 0: {
 //BA.debugLineNum = 43;BA.debugLine="Log(Job.GetString)";
