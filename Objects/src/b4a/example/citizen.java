...
int _lightcyan = 0;
 ...
 //BA.debugLineNum = 50;BA.debugLine="Activity.LoadLayout(\"citizen\")";
mostCurrent._activity.LoadLayout("citizen",mostCurrent.activityBA);
 //BA.debugLineNum = 51;BA.debugLine="Dim BarSize As Int: BarSize = 60dip";
_barsize = 0;
 //BA.debugLineNum = 51;BA.debugLine="Dim BarSize As Int: BarSize = 60dip";
_barsize = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60));
 //BA.debugLineNum = 52;BA.debugLine="FakeActionBar.Initialize(\"\")";
mostCurrent._fakeactionbar.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 53;BA.debugLine="FakeActionBar.Color = Colors.RGB(20, 20, 100) 'Da";
mostCurrent._fakeactionbar.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (20),(int) (20),(int) (100)));
 //BA.debugLineNum = 54;BA.debugLine="Activity.AddView(FakeActionBar, 0, 0, 100%x, BarS";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._fakeactionbar.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),_barsize);
 //BA.debugLineNum = 56;BA.debugLine="Dim LightCyan As Int: LightCyan = Colors.RGB(0, 9";
_lightcyan = 0;
 //BA.debugLineNum = 56;BA.debugLine="Dim LightCyan As Int: LightCyan = Colors.RGB(0, 9";
_lightcyan = anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (0),(int) (95),(int) (170));
 //BA.debugLineNum = 57;BA.debugLine="UnderActionBar.Initialize(\"\")";
mostCurrent._underactionbar.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 58;BA.debugLine="UnderActionBar.Color = LightCyan";
mostCurrent._underactionbar.setColor(_lightcyan);
 //BA.debugLineNum = 59;BA.debugLine="Activity.AddView(UnderActionBar, 0, BarSize, 100%";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._underactionbar.getObject()),(int) (0),_barsize,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),(int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-_barsize));
 //BA.debugLineNum = 61;BA.debugLine="PanelWithSidebar.Initialize(UnderActionBar, 190di";
mostCurrent._panelwithsidebar._initialize(mostCurrent.activityBA,mostCurrent._underactionbar,anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (190)),(byte) (2),(byte) (1),(int) (500),(int) (500));
 //BA.debugLineNum = 62;BA.debugLine="PanelWithSidebar.ContentPanel.Color = LightCyan";
mostCurrent._panelwithsidebar._contentpanel().setColor(_lightcyan);
 //BA.debugLineNum = 63;BA.debugLine="PanelWithSidebar.Sidebar.Background = PanelWithSi";
...
mostCurrent._panelwithsidebar._sidebar().AddView((android.view.View)(mostCurrent._lvmenu.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)),(int) (-1),(int) (-1));
 //BA.debugLineNum = 77;BA.debugLine="Webview1.Initialize(\"\")";
mostCurrent._webview1.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 78;BA.debugLine="Webview1.LoadUrl(domain&\"ta_v2/endpoint/view/laye";
...
mostCurrent._panelwithsidebar._setopenclosebutton((anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._btnmenu.getObject())));
 //BA.debugLineNum = 88;BA.debugLine="Activity.LoadLayout(\"citizen\")";
mostCurrent._activity.LoadLayout("citizen",mostCurrent.activityBA);
 //BA.debugLineNum = 90;BA.debugLine="Panel1.Width=Activity.Width";
mostCurrent._panel1.setWidth(mostCurrent._activity.getWidth());
 //BA.debugLineNum = 93;BA.debugLine="EditText1.Visible=False";
mostCurrent._edittext1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 94;BA.debugLine="Button1.Visible=False";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 95;BA.debugLine="Label1.Visible=False";
mostCurrent._label1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 96;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 100;BA.debugLine="Panel8.Visible=False";
...
String _citizen_id = "";
 //BA.debugLineNum = 164;BA.debugLine="Sub Button1_Click";
 //BA.debugLineNum = 166;BA.debugLine="Dim citizen_id As String";
_citizen_id = "";
 //BA.debugLineNum = 167;BA.debugLine="citizen_id=EditText1.Text";
_citizen_id = mostCurrent._edittext1.getText();
 //BA.debugLineNum = 169;BA.debugLine="If citizen_id=Null Then";
if (_citizen_id== null) { 
 //BA.debugLineNum = 170;BA.debugLine="citizen_id=\"\"";
_citizen_id = "";
 };
 //BA.debugLineNum = 174;BA.debugLine="job2.Initialize(\"Job2\", Me)";
mostCurrent._job2._initialize(processBA,"Job2",citizen.getObject());
 //BA.debugLineNum = 175;BA.debugLine="job2.PostString(domain&\"ta_v2/endpoint/citizen_by";
mostCurrent._job2._poststring(mostCurrent._domain+"ta_v2/endpoint/citizen_by_nik.php","citizen_id="+_citizen_id);
 //BA.debugLineNum = 176;BA.debugLine="Webview1.LoadUrl(domain&\"ta_v2/endpoint/view/land";
...
String _family_no = "";
 //BA.debugLineNum = 316;BA.debugLine="Sub Button2_Click";
 //BA.debugLineNum = 319;BA.debugLine="Dim family_no As String";
_family_no = "";
 //BA.debugLineNum = 320;BA.debugLine="family_no=EditText2.Text";
_family_no = mostCurrent._edittext2.getText();
 //BA.debugLineNum = 322;BA.debugLine="If family_no=Null Then";
if (_family_no== null) { 
 //BA.debugLineNum = 323;BA.debugLine="family_no=\"\"";
_family_no = "";
 };
 //BA.debugLineNum = 327;BA.debugLine="job2.Initialize(\"family_card\", Me)";
mostCurrent._job2._initialize(processBA,"family_card",citizen.getObject());
 //BA.debugLineNum = 328;BA.debugLine="job2.PostString(domain&\"ta_v2/endpoint/family_car";
mostCurrent._job2._poststring(mostCurrent._domain+"ta_v2/endpoint/family_card.php","family_no="+_family_no);
 //BA.debugLineNum = 329;BA.debugLine="Webview1.LoadUrl(domain&\"ta_v2/endpoint/view/laye";
mostCurrent._webview1.LoadUrl(mostCurrent._domain+"ta_v2/endpoint/view/layers.php");
...
String _status = "";
 ...
 //BA.debugLineNum = 182;BA.debugLine="Log(\"JobName = \" & Job.JobName & \", Success = \" &";
...
case 0: {
 //BA.debugLineNum = 188;BA.debugLine="Log(Job.GetString)";
anywheresoftware.b4a.keywords.Common.Log(_job._getstring());
 //BA.debugLineNum = 189;BA.debugLine="If Job.GetString=\"[]\" Then";
if ((_job._getstring()).equals("[]")) { 
 }else {
 //BA.debugLineNum = 192;BA.debugLine="Dim lv_size1 As Int";
_lv_size1 = 0;
 //BA.debugLineNum = 193;BA.debugLine="lv_size1=ListView1.Size";
_lv_size1 = mostCurrent._listview1.getSize();
 //BA.debugLineNum = 194;BA.debugLine="lv_size1=lv_size1-1";
_lv_size1 = (int) (_lv_size1-1);
 //BA.debugLineNum = 195;BA.debugLine="Log(lv_size1)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_lv_size1));
 //BA.debugLineNum = 196;BA.debugLine="If lv_size1>0 Then";
if (_lv_size1>0) { 
 //BA.debugLineNum = 198;BA.debugLine="Do While lv_size1>=0";
while (_lv_size1>=0) {
 //BA.debugLineNum = 200;BA.debugLine="Log(lv_size1)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_lv_size1));
 //BA.debugLineNum = 201;BA.debugLine="ListView1.RemoveAt(lv_size1)";
mostCurrent._listview1.RemoveAt(_lv_size1);
 //BA.debugLineNum = 202;BA.debugLine="lv_size1=lv_size1-1";
_lv_size1 = (int) (_lv_size1-1);
 }
;
 };
 //BA.debugLineNum = 210;BA.debugLine="JSON.Initialize(Job.GetString)";
mostCurrent._json.Initialize(_job._getstring());
 //BA.debugLineNum = 212;BA.debugLine="Map1 = JSON.NextObject";
mostCurrent._map1 = mostCurrent._json.NextObject();
 //BA.debugLineNum = 213;BA.debugLine="Log(Map1)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._map1));
 //BA.debugLineNum = 223;BA.debugLine="ListView1.SingleLineLayout.Label.TextColor =";
mostCurrent._listview1.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 225;BA.debugLine="ListView1.AddSingleLine( \"Nik:\"&Map1.Get(\"nik";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence("Nik:"+BA.ObjectToString(mostCurrent._map1.Get((Object)("nik")))));
 //BA.debugLineNum = 226;BA.debugLine="ListView1.AddSingleLine( \"Status:\"&Map1.Get(\"";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence("Status:"+BA.ObjectToString(mostCurrent._map1.Get((Object)("status_name")))));
 //BA.debugLineNum = 227;BA.debugLine="ListView1.AddSingleLine( \"Clan:\"&Map1.Get(\"cl";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence("Clan:"+BA.ObjectToString(mostCurrent._map1.Get((Object)("clan_name")))));
 //BA.debugLineNum = 228;BA.debugLine="ListView1.AddSingleLine( \"Name:\"&Map1.Get(\"ci";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence("Name:"+BA.ObjectToString(mostCurrent._map1.Get((Object)("citizen_name")))));
 //BA.debugLineNum = 229;BA.debugLine="ListView1.AddSingleLine( \"Phone:\"&Map1.Get(\"p";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence("Phone:"+BA.ObjectToString(mostCurrent._map1.Get((Object)("phone")))));
 //BA.debugLineNum = 230;BA.debugLine="ListView1.AddSingleLine( \"Gender:\"&Map1.Get(\"";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence("Gender:"+BA.ObjectToString(mostCurrent._map1.Get((Object)("gender")))));
 //BA.debugLineNum = 231;BA.debugLine="ListView1.SingleLineLayout.Label.TextSize = 1";
mostCurrent._listview1.getSingleLineLayout().Label.setTextSize((float) (14));
 };
 break; }
case 1: {
 //BA.debugLineNum = 236;BA.debugLine="If Job.GetString=\"[]\" Then";
if ((_job._getstring()).equals("[]")) { 
 }else {
 //BA.debugLineNum = 240;BA.debugLine="JSON.Initialize(Job.GetString)";
mostCurrent._json.Initialize(_job._getstring());
 //BA.debugLineNum = 241;BA.debugLine="Map1 = JSON.NextObject";
mostCurrent._map1 = mostCurrent._json.NextObject();
 //BA.debugLineNum = 242;BA.debugLine="Log(Map1)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._map1));
 //BA.debugLineNum = 245;BA.debugLine="parser.Initialize(Job.GetString)";
mostCurrent._parser.Initialize(_job._getstring());
 //BA.debugLineNum = 246;BA.debugLine="Dim root As Map = parser.NextObject";
_root = new anywheresoftware.b4a.objects.collections.Map();
_root = mostCurrent._parser.NextObject();
 //BA.debugLineNum = 247;BA.debugLine="Dim Type As String = root.Get(\"type\")";
_type = BA.ObjectToString(_root.Get((Object)("type")));
 //BA.debugLineNum = 248;BA.debugLine="Dim results As List = root.Get(\"results\")";
_results = new anywheresoftware.b4a.objects.collections.List();
_results.setObject((java.util.List)(_root.Get((Object)("results"))));
 //BA.debugLineNum = 250;BA.debugLine="Dim H As Int";
_h = 0;
 //BA.debugLineNum = 251;BA.debugLine="H=0";
_h = (int) (0);
 //BA.debugLineNum = 252;BA.debugLine="Dim gd1 As GradientDrawable";
_gd1 = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 253;BA.debugLine="gd1.Initialize(\"BOTTOM_TOP\", Array As Int (Co";
_gd1.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"BOTTOM_TOP"),new int[]{anywheresoftware.b4a.keywords.Common.Colors.Magenta,anywheresoftware.b4a.keywords.Common.Colors.Magenta,anywheresoftware.b4a.keywords.Common.Colors.Magenta});
 //BA.debugLineNum = 255;BA.debugLine="Dim gd2 As GradientDrawable";
_gd2 = new anywheresoftware.b4a.objects.drawable.GradientDrawable();
 //BA.debugLineNum = 256;BA.debugLine="gd2.Initialize(\"BOTTOM_TOP\", Array As Int (Co";
_gd2.Initialize(BA.getEnumFromString(android.graphics.drawable.GradientDrawable.Orientation.class,"BOTTOM_TOP"),new int[]{anywheresoftware.b4a.keywords.Common.Colors.Gray,anywheresoftware.b4a.keywords.Common.Colors.Gray,anywheresoftware.b4a.keywords.Common.Colors.Gray});
 //BA.debugLineNum = 258;BA.debugLine="Dim lv_size As Int";
_lv_size = 0;
 //BA.debugLineNum = 259;BA.debugLine="lv_size=ListView2.Size";
_lv_size = mostCurrent._listview2.getSize();
 //BA.debugLineNum = 260;BA.debugLine="lv_size=lv_size-1";
_lv_size = (int) (_lv_size-1);
 //BA.debugLineNum = 261;BA.debugLine="Log(lv_size)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_lv_size));
 //BA.debugLineNum = 262;BA.debugLine="If lv_size>0 Then";
if (_lv_size>0) { 
 //BA.debugLineNum = 264;BA.debugLine="Do While lv_size>=0";
while (_lv_size>=0) {
 //BA.debugLineNum = 266;BA.debugLine="Log(lv_size)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_lv_size));
 //BA.debugLineNum = 267;BA.debugLine="ListView2.RemoveAt(lv_size)";
mostCurrent._listview2.RemoveAt(_lv_size);
 //BA.debugLineNum = 268;BA.debugLine="lv_size=lv_size-1";
_lv_size = (int) (_lv_size-1);
 }
;
 };
 //BA.debugLineNum = 279;BA.debugLine="For Each colresults As Map In results";
...
_colresults.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(group58.Get(index58)));
 //BA.debugLineNum = 280;BA.debugLine="H=H+1";
_h = (int) (_h+1);
 //BA.debugLineNum = 281;BA.debugLine="Dim clan_name As String = colresults.Get(\"cl";
_clan_name = BA.ObjectToString(_colresults.Get((Object)("clan_name")));
 //BA.debugLineNum = 282;BA.debugLine="Dim citizen_name As String = colresults.Get(";
_citizen_name = BA.ObjectToString(_colresults.Get((Object)("citizen_name")));
 //BA.debugLineNum = 285;BA.debugLine="Dim gender As String = colresults.Get(\"gende";
_gender = BA.ObjectToString(_colresults.Get((Object)("gender")));
 //BA.debugLineNum = 289;BA.debugLine="Dim nik As String = colresults.Get(\"nik\")";
_nik = BA.ObjectToString(_colresults.Get((Object)("nik")));
 //BA.debugLineNum = 292;BA.debugLine="Dim phone As String = colresults.Get(\"phone\"";
_phone = BA.ObjectToString(_colresults.Get((Object)("phone")));
 //BA.debugLineNum = 293;BA.debugLine="Dim born_date As String = colresults.Get(\"bo";
_born_date = BA.ObjectToString(_colresults.Get((Object)("born_date")));
 //BA.debugLineNum = 294;BA.debugLine="Dim status As String = colresults.Get(\"statu";
_status = BA.ObjectToString(_colresults.Get((Object)("status")));
 //BA.debugLineNum = 295;BA.debugLine="ListView2.SingleLineLayout.Label.TextColor =";
mostCurrent._listview2.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 296;BA.debugLine="If H Mod 2=0 Then";
if (_h%2==0) { 
 //BA.debugLineNum = 297;BA.debugLine="ListView2.SingleLineLayout.Background = gd1";
mostCurrent._listview2.getSingleLineLayout().Background = (android.graphics.drawable.Drawable)(_gd1.getObject());
 }else {
 //BA.debugLineNum = 299;BA.debugLine="ListView2.SingleLineLayout.Background = gd2";
mostCurrent._listview2.getSingleLineLayout().Background = (android.graphics.drawable.Drawable)(_gd2.getObject());
 };
 //BA.debugLineNum = 302;BA.debugLine="ListView2.AddSingleLine(\"Clan: \"&clan_name&\"";
mostCurrent._listview2.AddSingleLine(BA.ObjectToCharSequence("Clan: "+_clan_name+" "+" Name: "+_citizen_name+" Gender: "+_gender+" "+" Id: "+_nik+" "+" Status: "+_status+" "+" Born Date: "+_born_date+" "+" Phone: "+_phone+" "));
 //BA.debugLineNum = 303;BA.debugLine="ListView2.SingleLineLayout.Label.TextSize =";
...
;
 ...
 //BA.debugLineNum = 310;BA.debugLine="Log(\"Error: \" & Job.ErrorMessage)";
...
public static String  _lvmenu_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 116;BA.debugLine="Sub lvMenu_ItemClick (Position As Int, Value As Ob";
 //BA.debugLineNum = 118;BA.debugLine="Log(Position)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_position));
 //BA.debugLineNum = 119;BA.debugLine="Log(Value)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(_value));
 //BA.debugLineNum = 120;BA.debugLine="If Position=0 Then";
if (_position==0) { 
 //BA.debugLineNum = 122;BA.debugLine="Panel8.Visible=False";
mostCurrent._panel8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 125;BA.debugLine="Panel1.Visible=True";
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 126;BA.debugLine="EditText1.Visible=True";
mostCurrent._edittext1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 127;BA.debugLine="Button1.Visible=True";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 128;BA.debugLine="Label1.Visible=True";
mostCurrent._label1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 129;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 }else if(_position==1) { 
 //BA.debugLineNum = 135;BA.debugLine="EditText1.Visible=False";
mostCurrent._edittext1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 136;BA.debugLine="Button1.Visible=False";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 137;BA.debugLine="Label1.Visible=False";
mostCurrent._label1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 138;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 141;BA.debugLine="Panel1.Visible=False";
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 142;BA.debugLine="Panel8.Left=Panel1.Left";
mostCurrent._panel8.setLeft(mostCurrent._panel1.getLeft());
 //BA.debugLineNum = 144;BA.debugLine="Panel8.Visible=True";
mostCurrent._panel8.setVisible(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 148;BA.debugLine="PanelWithSidebar.CloseSidebar";
mostCurrent._panelwithsidebar._closesidebar();
 //BA.debugLineNum = 149;BA.debugLine="End Sub";
return "";
}
public static String  _menu_onfullyclosed() throws Exception{
 //BA.debugLineNum = 155;BA.debugLine="Sub Menu_onFullyClosed";
 //BA.debugLineNum = 157;BA.debugLine="End Sub";
return "";
}
public static String  _menu_onfullyopen() throws Exception{
 //BA.debugLineNum = 151;BA.debugLine="Sub Menu_onFullyOpen";
 //BA.debugLineNum = 153;BA.debugLine="End Sub";
return "";
}
public static String  _menu_onmove(boolean _isopening) throws Exception{
 //BA.debugLineNum = 159;BA.debugLine="Sub Menu_onMove(IsOpening As Boolean)";
