...
mostCurrent._lvmenu.Initialize(mostCurrent.activityBA,"lvMenu");
 //BA.debugLineNum = 62;BA.debugLine="lvMenu.AddSingleLine(\"Search Citizen\")";
mostCurrent._lvmenu.AddSingleLine(BA.ObjectToCharSequence("Search Citizen"));
 //BA.debugLineNum = 63;BA.debugLine="lvMenu.AddSingleLine(\"Family Card\")";
mostCurrent._lvmenu.AddSingleLine(BA.ObjectToCharSequence("Family Card"));
 //BA.debugLineNum = 64;BA.debugLine="lvMenu.AddSingleLine(\"Birth Data\")";
mostCurrent._lvmenu.AddSingleLine(BA.ObjectToCharSequence("Birth Data"));
 //BA.debugLineNum = 65;BA.debugLine="lvMenu.AddSingleLine(\"Mortality Data\")";
mostCurrent._lvmenu.AddSingleLine(BA.ObjectToCharSequence("Mortality Data"));
 //BA.debugLineNum = 66;BA.debugLine="lvMenu.AddSingleLine(\"Outcomes\")";
...
mostCurrent._panelwithsidebar._sidebar().AddView((android.view.View)(mostCurrent._lvmenu.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (25)),(int) (-1),(int) (-1));
 //BA.debugLineNum = 72;BA.debugLine="Webview1.Initialize(\"\")";
mostCurrent._webview1.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 73;BA.debugLine="Webview1.LoadUrl(domain&\"ta_v2/endpoint/view/laye";
mostCurrent._webview1.LoadUrl(mostCurrent._domain+"ta_v2/endpoint/view/layers.php");
 //BA.debugLineNum = 77;BA.debugLine="PanelWithSidebar.ContentPanel.AddView(Webview1, 0";
mostCurrent._panelwithsidebar._contentpanel().AddView((android.view.View)(mostCurrent._webview1.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0))),(int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1))));
 //BA.debugLineNum = 79;BA.debugLine="btnMenu.Initialize(\"\")";
mostCurrent._btnmenu.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 80;BA.debugLine="btnMenu.SetBackgroundImage(LoadBitmap(File.DirAss";
mostCurrent._btnmenu.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"menu.png").getObject()));
 //BA.debugLineNum = 81;BA.debugLine="FakeActionBar.AddView(btnMenu, 100%x - BarSize, 0";
mostCurrent._fakeactionbar.AddView((android.view.View)(mostCurrent._btnmenu.getObject()),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-_barsize),(int) (0),_barsize,_barsize);
 //BA.debugLineNum = 82;BA.debugLine="PanelWithSidebar.SetOpenCloseButton(btnMenu)";
mostCurrent._panelwithsidebar._setopenclosebutton((anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._btnmenu.getObject())));
 //BA.debugLineNum = 83;BA.debugLine="Activity.LoadLayout(\"citizen\")";
mostCurrent._activity.LoadLayout("citizen",mostCurrent.activityBA);
 //BA.debugLineNum = 85;BA.debugLine="Panel1.Width=Activity.Width";
mostCurrent._panel1.setWidth(mostCurrent._activity.getWidth());
 //BA.debugLineNum = 88;BA.debugLine="EditText1.Visible=False";
mostCurrent._edittext1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 89;BA.debugLine="Button1.Visible=False";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 90;BA.debugLine="Label1.Visible=False";
mostCurrent._label1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 91;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 95;BA.debugLine="Panel8.Visible=False";
...
String _citizen_id = "";
 ...
 //BA.debugLineNum = 161;BA.debugLine="Dim citizen_id As String";
_citizen_id = "";
 //BA.debugLineNum = 162;BA.debugLine="citizen_id=EditText1.Text";
_citizen_id = mostCurrent._edittext1.getText();
 //BA.debugLineNum = 164;BA.debugLine="If citizen_id=Null Then";
if (_citizen_id== null) { 
 //BA.debugLineNum = 165;BA.debugLine="citizen_id=\"\"";
_citizen_id = "";
 };
 //BA.debugLineNum = 169;BA.debugLine="job2.Initialize(\"Job2\", Me)";
mostCurrent._job2._initialize(processBA,"Job2",citizen.getObject());
 //BA.debugLineNum = 170;BA.debugLine="job2.PostString(domain&\"ta_v2/endpoint/citizen_by";
mostCurrent._job2._poststring(mostCurrent._domain+"ta_v2/endpoint/citizen_by_nik.php","citizen_id="+_citizen_id);
 //BA.debugLineNum = 171;BA.debugLine="Webview1.LoadUrl(domain&\"ta_v2/endpoint/view/land";
...
String _family_no = "";
 ...
 //BA.debugLineNum = 226;BA.debugLine="Dim family_no As String";
_family_no = "";
 //BA.debugLineNum = 227;BA.debugLine="family_no=EditText2.Text";
_family_no = mostCurrent._edittext2.getText();
 //BA.debugLineNum = 229;BA.debugLine="If family_no=Null Then";
if (_family_no== null) { 
 //BA.debugLineNum = 230;BA.debugLine="family_no=\"\"";
_family_no = "";
 };
 //BA.debugLineNum = 234;BA.debugLine="job2.Initialize(\"family_card\", Me)";
mostCurrent._job2._initialize(processBA,"family_card",citizen.getObject());
 //BA.debugLineNum = 235;BA.debugLine="job2.PostString(domain&\"ta_v2/endpoint/citizen_by";
mostCurrent._job2._poststring(mostCurrent._domain+"ta_v2/endpoint/citizen_by_nik.php","family_no="+_family_no);
 //BA.debugLineNum = 236;BA.debugLine="Webview1.LoadUrl(domain&\"ta_v2/endpoint/view/land";
mostCurrent._webview1.LoadUrl(mostCurrent._domain+"ta_v2/endpoint/view/land_owning.php?family_no="+_family_no);
...
mostCurrent._domain = "";
 //BA.debugLineNum = 20;BA.debugLine="domain=\"http://aaf4fde1.ngrok.io/\"";
mostCurrent._domain = "http://aaf4fde1.ngrok.io/";
...
mostCurrent._listview1 = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 30;BA.debugLine="Private ListView2 As ListView";
...
mostCurrent._panel3 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 34;BA.debugLine="Private Panel6 As Panel";
...
mostCurrent._panel1 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 38;BA.debugLine="Private Panel8 As Panel";
...
mostCurrent._panel7 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 40;BA.debugLine="Private Panel9 As Panel";
mostCurrent._panel9 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 41;BA.debugLine="Private EditText2 As EditText";
...
case 0: {
 //BA.debugLineNum = 183;BA.debugLine="Log(Job.GetString)";
anywheresoftware.b4a.keywords.Common.Log(_job._getstring());
 //BA.debugLineNum = 184;BA.debugLine="If Job.GetString=\"[]\" Then";
if ((_job._getstring()).equals("[]")) { 
 }else {
 //BA.debugLineNum = 187;BA.debugLine="JSON.Initialize(Job.GetString)";
mostCurrent._json.Initialize(_job._getstring());
 //BA.debugLineNum = 189;BA.debugLine="Map1 = JSON.NextObject";
mostCurrent._map1 = mostCurrent._json.NextObject();
 //BA.debugLineNum = 190;BA.debugLine="Log(Map1)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._map1));
 //BA.debugLineNum = 200;BA.debugLine="ListView1.SingleLineLayout.Label.TextColor =";
mostCurrent._listview1.getSingleLineLayout().Label.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 202;BA.debugLine="ListView1.AddSingleLine( \"Nik:\"&Map1.Get(\"nik";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence("Nik:"+BA.ObjectToString(mostCurrent._map1.Get((Object)("nik")))));
 //BA.debugLineNum = 203;BA.debugLine="ListView1.AddSingleLine( \"Status:\"&Map1.Get(\"";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence("Status:"+BA.ObjectToString(mostCurrent._map1.Get((Object)("status_name")))));
 //BA.debugLineNum = 204;BA.debugLine="ListView1.AddSingleLine( \"Clan:\"&Map1.Get(\"cl";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence("Clan:"+BA.ObjectToString(mostCurrent._map1.Get((Object)("clan_name")))));
 //BA.debugLineNum = 205;BA.debugLine="ListView1.AddSingleLine( \"Name:\"&Map1.Get(\"ci";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence("Name:"+BA.ObjectToString(mostCurrent._map1.Get((Object)("citizen_name")))));
 //BA.debugLineNum = 206;BA.debugLine="ListView1.AddSingleLine( \"Phone:\"&Map1.Get(\"p";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence("Phone:"+BA.ObjectToString(mostCurrent._map1.Get((Object)("phone")))));
 //BA.debugLineNum = 207;BA.debugLine="ListView1.AddSingleLine( \"Gender:\"&Map1.Get(\"";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence("Gender:"+BA.ObjectToString(mostCurrent._map1.Get((Object)("gender")))));
 //BA.debugLineNum = 208;BA.debugLine="ListView1.SingleLineLayout.Label.TextSize = 1";
...
anywheresoftware.b4a.keywords.Common.Log("Error: "+_job._errormessage);
 //BA.debugLineNum = 218;BA.debugLine="ToastMessageShow(\"Error: \" & Job.ErrorMessage, T";
...
public static String  _lvmenu_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 111;BA.debugLine="Sub lvMenu_ItemClick (Position As Int, Value As Ob";
 //BA.debugLineNum = 113;BA.debugLine="Log(Position)";
...
if (_position==0) { 
 //BA.debugLineNum = 117;BA.debugLine="Panel8.Visible=False";
mostCurrent._panel8.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 120;BA.debugLine="Panel1.Visible=True";
mostCurrent._panel1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 121;BA.debugLine="EditText1.Visible=True";
mostCurrent._edittext1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 122;BA.debugLine="Button1.Visible=True";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 123;BA.debugLine="Label1.Visible=True";
mostCurrent._label1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 124;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 }else if(_position==1) { 
 //BA.debugLineNum = 130;BA.debugLine="EditText1.Visible=False";
mostCurrent._edittext1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 131;BA.debugLine="Button1.Visible=False";
mostCurrent._button1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 132;BA.debugLine="Label1.Visible=False";
mostCurrent._label1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 133;BA.debugLine="ListView1.Visible=False";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
